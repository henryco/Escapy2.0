...
\textit{\textbf{DefaultLocationLoader}} которая в свою очередь сможет загрузить локацию из json файла. \textit{\textbf{DefaultLocationLoader}} в конструкторе получает инстанцию очередного загрузчика \textit{\textbf{DefaultSubLocationLoader}}, а тот в свою очередь 
